...
if (empty($update_url)) {
    $update_url = 'https://github.com/Goz1996/mikrotik/archive/refs/heads/master.zip';
}
...
$file = pathFixer('system/cache/freeispradis.zip');
$folder = pathFixer('system/cache/freeispradius-' . basename($update_url, ".zip") . '/');
