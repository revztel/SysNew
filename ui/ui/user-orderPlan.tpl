...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="box box-solid box-primary bg-gray">
            ...
            {/if}
            {if $_user['service_type'] == 'Static' && Validator::countRouterPlan($plans_static,$router['name'])>0}
            <div class="box-header text-white">{if $_c['static_plan']==''}Static Plan{else}{$_c['static_plan']}{/if}</div>
            <div class="box-body row">
