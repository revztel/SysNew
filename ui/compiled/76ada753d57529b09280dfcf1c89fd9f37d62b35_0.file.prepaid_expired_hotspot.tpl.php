<?php
/* Smarty version 4.3.1, created on 2024-06-09 18:49:06
  from 'F:\xampp\htdocs\radius\ui\themes\nova\prepaid_expired_hotspot.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6665cef208b636_56761249',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '76ada753d57529b09280dfcf1c89fd9f37d62b35' => 
    array (
...
function content_6665cef208b636_56761249 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="col-sm-12">
        <div class="panel panel-hovered mb20 panel-primary">
            <div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
                <span><?php echo Lang::T('Expired Packages');?>
</span>
...
customers/csv-prepaid" onclick="return confirm('This will export to CSV?')">
            ...
            <ul class="nav nav-tabs nav-justified">
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'expired_packages') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/expired_packages" class="bg-primary">
                        <i class="fa fa-users"></i> <?php echo Lang::T('All Expired');?>

                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'expired_hotspot') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/expired_hotspot" class="bg-warning">
                        <i class="fa fa-wifi"></i> <?php echo Lang::T('Hotspot');?>

                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'expired_static') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/expired_static" class="bg-info">
                        <i class="fa fa-desktop"></i> <?php echo Lang::T('Static');?>

                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'expired_pppoe') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/expired_pppoe" class="bg-purple">
