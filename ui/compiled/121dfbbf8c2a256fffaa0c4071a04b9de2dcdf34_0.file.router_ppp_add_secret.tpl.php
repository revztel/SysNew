<?php
/* Smarty version 4.3.1, created on 2024-09-18 23:41:43
  from 'F:\xampp\htdocs\radius\ui\themes\nova\router_ppp_add_secret.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_66eb3b07495052_60229446',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '121dfbbf8c2a256fffaa0c4071a04b9de2dcdf34' => 
    array (
...
function content_66eb3b07495052_60229446 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="col-sm-12">
        <div class="panel panel-hovered mb20 panel-primary">
            <div class="panel-heading">
                <?php echo Lang::T('Add Secret');?>

            </div>
            <div class="panel-body">
                <form method="post" action="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
router_ppp/add-secret/<?php echo $_smarty_tpl->tpl_vars['router_id']->value;?>
">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="enabled"> <?php echo Lang::T('Enable Secret');?>

                        </label>
                    </div>
                    <button type="submit" class="btn btn-primary"><?php echo Lang::T('Add Secret');?>
</button>
                </form>
            </div>
        </div>
