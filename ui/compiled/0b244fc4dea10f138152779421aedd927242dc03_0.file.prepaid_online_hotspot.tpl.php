<?php
/* Smarty version 4.3.1, created on 2024-06-09 18:58:15
  from 'F:\xampp\htdocs\radius\ui\themes\nova\prepaid_online_hotspot.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6665d117d57e21_00841480',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0b244fc4dea10f138152779421aedd927242dc03' => 
    array (
...
function content_6665d117d57e21_00841480 (Smarty_Internal_Template $_smarty_tpl) {
...
customers/csv-prepaid" onclick="return confirm('This will export to CSV?')">
            ...
            <ul class="nav nav-tabs nav-justified">
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'online_users') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/online_users" class="bg-primary">
                        <i class="fa fa-users"></i> <?php echo Lang::T('All Online');?>

                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'online_hotspot') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/online_hotspot" class="bg-warning">
                        <i class="fa fa-wifi"></i> <?php echo Lang::T('Hotspot');?>

                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'online_static') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/online_static" class="bg-info">
                        <i class="fa fa-desktop"></i> <?php echo Lang::T('Static');?>

                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'online_pppoe') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/online_pppoe" class="bg-purple">
