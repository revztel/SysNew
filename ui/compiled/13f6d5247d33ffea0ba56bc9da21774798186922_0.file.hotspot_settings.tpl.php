<?php
/* Smarty version 4.3.1, created on 2025-01-06 17:40:15
  from '/var/www/html/demo/system/plugin/ui/hotspot_settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_677beb4f011728_58542813',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '13f6d5247d33ffea0ba56bc9da21774798186922' => 
    array (
...
function content_677beb4f011728_58542813 (Smarty_Internal_Template $_smarty_tpl) {
...
<section class="content">
    ...
    <!-- Country Navigation Tabs (Similar to Bridge and Ports Tabs) -->
...
plugin/hotspot_settings_philippines"><?php echo Lang::T('Philippines');?>
    ...
    <!-- Tab Content: We show Kenya's hotspot settings here -->
    <!-- If you navigate to Tanzania's URL, you'd load a similar tpl for Tanzania -->
    <div class="tab-content">
        <div id="kenya" class="tab-pane fade in active">
            <!-- Main Hotspot Settings Form -->
            <div class="row">
                <div class="col-md-12">
...
" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <small class="form-text text-muted">Select to enable or disable the free trial feature. Default is "Disable".</small>
                                    </div>
                                </div>
                    ...
                    <div class="box box-primary box-solid">
                        ...
                        <div class="box-body">
                            <div class="callout callout-info">
                                ...
                                <ol>
                                    <li>For a quick upload, try clicking "Save Changes and Upload File" twice. If not, follow the steps below.</li>
                                    <li>Customize your settings as desired.</li>
                                    <li>Download the <code>login.html</code> file by clicking on the "Download Login Page" button.</li>
                                    <li>Upload the <code>login.html</code> file to your MikroTik router.</li>
                                    <li>Ensure the file is named <code>login.html</code>.</li>
