<?php
/* Smarty version 4.3.1, created on 2024-06-09 18:56:09
  from 'F:\xampp\htdocs\radius\ui\themes\nova\prepaid_offline_hotspot.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6665d0998484f4_89953730',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f212e791c1fbd5df1e197d0c45c349bfde7b67ed' => 
    array (
...
function content_6665d0998484f4_89953730 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="col-sm-12">
        <div class="panel panel-hovered mb20 panel-primary">
            <div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
                <span><?php echo Lang::T('Offline Users');?>
</span>
...
customers/csv-prepaid" onclick="return confirm('This will export to CSV?')">
            ...
            <ul class="nav nav-tabs nav-justified">
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'offline_users') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/offline_users" class="bg-primary">
                        <i class="fa fa-users"></i> <?php echo Lang::T('All Offline');?>

                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'offline_hotspot') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/offline_hotspot" class="bg-warning">
                        <i class="fa fa-wifi"></i> <?php echo Lang::T('Hotspot');?>

                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'offline_static') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/offline_static" class="bg-info">
                        <i class="fa fa-desktop"></i> <?php echo Lang::T('Static');?>

                    </a>
                </li>
                <li class="<?php if ($_smarty_tpl->tpl_vars['filter']->value == 'offline_pppoe') {?>active<?php }?>">
                    <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
prepaid/offline_pppoe" class="bg-purple">
