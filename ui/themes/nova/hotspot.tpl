        ...
        <div class="panel panel-hovered mb20 panel-primary">
            <div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="btn-group">
                    ...
                    <!-- Sync All Button -->
                    <a class="btn btn-primary btn-xs" title="Sync All" href="{$_url}services/sync/hotspot" onclick="return confirm('This will sync/send all hotspot plans to all MikroTik routers?')">
            ...
            <div class="panel-body">
                <div class="md-whiteframe-z1 mb20 text-center" style="padding: 15px">
                    ...
                    <div class="col-md-4">
                        <a href="{$_url}services/add" class="btn btn-primary btn-block"><i class="ion ion-android-add"> </i> {Lang::T('New Service Plan')}</a>
                    </div>&nbsp;
                </div>
                        ...
                        <tbody>
                            {foreach $d as $ds}
                                <tr>
                                    ...
                                    <td>
                                        <a href="{$_url}services/edit/{$ds['id']}" class="btn btn-info btn-xs">{Lang::T('Edit')}</a>
                                        <a href="{$_url}services/delete/{$ds['id']}" id="{$ds['id']}" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                    </td>
                                    <td>{$ds['id']}</td>
                                </tr>
                            {/foreach}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="routerSyncForm" method="post" action="{$_url}services/sync-hotspot">
