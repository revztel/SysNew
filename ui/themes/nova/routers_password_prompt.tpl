    ...
    <div class="col-md-6">
        <div class="panel panel-hovered mb20 panel-primary">
            <div class="panel-heading d-flex justify-content-between align-items-center">
                <span>{Lang::T('Enter Password')}</span>
            </div>
            <div class="panel-body">
                ...
                <form method="post" action="">
                    <div class="form-group">
                        <label for="router_password" class="font-weight-bold">{Lang::T('Password')}</label>
                    ...
                    <a href="{$_url}routers/forgot_password" class="btn btn-link mt-3">{Lang::T('Forgot Password?')}</a>
                </form>
            </div>
        </div>
    </div>
