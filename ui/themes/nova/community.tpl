...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="box box-hovered mb20 box-primary">
            ...
            <div class="box-footer">
                <a href="https://sms.ispledger.com" target="_blank" class="btn btn-primary btn-sm btn-block">Server</a>
            </div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="box box-primary box-hovered mb20 activities">
            ...
            <div class="box-footer">
                <a href="https://whatsapp.ispledger.com" target="_blank"
                    class="btn btn-primary btn-sm btn-block">whatsapp.ispledger.com</a>
            </div>
        </div>
    </div>
