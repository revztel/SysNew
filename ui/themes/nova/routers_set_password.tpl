    ...
    <div class="col-md-6">
        <div class="panel panel-hovered mb20 panel-primary">
            <div class="panel-heading d-flex justify-content-between align-items-center">
                <span>{Lang::T('Set Your Password')}</span>
            </div>
            <div class="panel-body">
                ...
                <form method="post" action="">
                    <div class="form-group">
                        <label for="new_router_password" class="font-weight-bold">{Lang::T('New Password')}</label>
                    ...
                    <div class="form-group">
                        <label for="confirm_router_password" class="font-weight-bold">{Lang::T('Confirm Password')}</label>
                    ...
                    <button type="submit" class="btn btn-primary btn-block btn-lg mt-4">{Lang::T('Set Password')}</button>
                </form>
            </div>
        </div>
    </div>
