    ...
    <div class="col-sm-12">
        <div class="panel panel-hovered mb20 panel-primary">
            <div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
                <span>{Lang::T('Static IP Plans')}</span>
                <div class="btn-group">
                    <!-- Need Help Button -->
                    ...
                    <!-- Sync All Button -->
                    <a class="btn btn-primary btn-xs" title="Sync All" href="{$_url}services/sync/static" onclick="return confirm('Are you sure you want to sync Static IP Plans?')">
            ...
            <div class="panel-body">
                <div class="md-whiteframe-z1 mb20 text-center" style="padding: 15px">
                    <div class="col-md-8">
                        <form id="site-search" method="post" action="{$_url}services/static-ip/">
                    ...
                    <div class="col-md-4">
                        <a href="{$_url}services/static-add" class="btn btn-primary btn-block waves-effect"><i class="ion ion-android-add"> </i> {Lang::T('New Service Plan')}</a>
                    </div>&nbsp;
                </div>
                        ...
                        <tbody>
                            {foreach $d as $ds}
                                <tr {if $ds['enabled'] != 1}class="danger" title="disabled"
                                    ...
                                    <td>
                                        <a href="{$_url}services/static-edit/{$ds['id']}" class="btn btn-info btn-xs">{Lang::T('Edit')}</a>
                                        <a href="{$_url}services/static-delete/{$ds['id']}" onclick="return confirm('{Lang::T('Delete')}?')" id="{$ds['id']}" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                    </td>
                                    <td>{$ds['id']}</td>
                                </tr>
                            {/foreach}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="routerSyncForm" method="post" action="{$_url}services/sync-static">
