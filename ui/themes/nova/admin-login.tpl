...
<body>
  ...
  <div class="login text-center">
    ...
    {if $show_login_form}
      ...
      <form action="{$_url}admin/post" method="post" class="login__form">
        ...
        <div class="login__check">
          ...
          <a href="{$_url}admin/forgot-password" class="login__forgot">{Lang::T('Forgot Password?')}</a>
        </div>
        <button type="submit" class="login__button">{Lang::T('Login')}</button>
        <p class="login__register">
          <a href="{$_url}admin/forgot-password" target="_self">{Lang::T('Forgot Password')}</a> |
    ...
    {elseif $show_otp_form}
      <!-- OTP Input Form -->
      <form action="{$_url}admin/verify" method="post" class="login__form">
        <div class="login__content">
          <div class="login__box">
