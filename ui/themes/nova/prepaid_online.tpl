    ...
    <div class="col-sm-12">
        <div class="panel panel-hovered mb20 panel-primary">
            ...
            <ul class="nav nav-tabs nav-justified">
                <li class="{if $filter == 'online_users'}active{/if}">
                    <a href="{$_url}prepaid/online_users" class="bg-primary">
                        <i class="fa fa-users"></i> {Lang::T('All Online')}
                    </a>
                </li>
                <li class="{if $filter == 'online_hotspot'}active{/if}">
                    <a href="{$_url}prepaid/online_hotspot" class="bg-warning">
                        <i class="fa fa-wifi"></i> {Lang::T('Hotspot')}
                    </a>
                </li>
                <li class="{if $filter == 'online_static'}active{/if}">
                    <a href="{$_url}prepaid/online_static" class="bg-info">
                        <i class="fa fa-desktop"></i> {Lang::T('Static')}
                    </a>
                </li>
                <li class="{if $filter == 'online_pppoe'}active{/if}">
                    <a href="{$_url}prepaid/online_pppoe" class="bg-purple">
            ...
            <div class="panel-body">
                <div class="md-whiteframe-z1 mb20 text-center" style="padding: 15px">
                    <div class="col-md-8">
                        <form id="site-search" method="post" action="{$_url}prepaid/online_users">
