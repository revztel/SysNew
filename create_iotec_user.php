...
logToFile('user_creation_iotec.log', "Received data: " . print_r($data, true));
...
if (!empty($missingFields)) {
    logToFile('user_creation_iotec.log', "Missing fields: " . print_r($missingFields, true));
...
// Since the phone number is used as the username and name
$fullName = $phone;
...
if (!$Userexist) {
    ...
    $createUser->save();
    logToFile('user_creation_iotec.log', "User created successfully: " . $phone);
} else {
    logToFile('user_creation_iotec.log', "User already exists: " . $phone);
}
