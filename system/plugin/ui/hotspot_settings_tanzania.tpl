...
<section class="content-header">
    <h1>
        <div class="btn-group">
            <button type="button" class="btn btn-success btn-lg">
                <i class="fa fa-wifi"></i> Hotspot Settings - Tanzania
            </button>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Hotspot Settings - Tanzania</li>
    </ol>
</section>
...
<section class="content">
    <div class="row" style="margin-bottom: 20px;">
        <div class="col-md-12">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{$_url}plugin/hotspot_settings_tanzania">{Lang::T('Tanzania')}</a></li>
    ...
    <div class="tab-content">
        <div id="tanzania" class="tab-pane fade in active">
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary box-solid">
                        <div class="box-header with-border" style="display: flex; justify-content: space-between; align-items: center;">
                            <h3 class="box-title"><i class="fa fa-cog"></i> {Lang::T('General Settings')} - Tanzania</h3>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <small class="form-text text-muted">Enter your ISP company name as the hotspot page title for Tanzania.</small>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <small class="form-text text-muted">Select the router for the Tanzania hotspot configuration.</small>
                                    </div>
                                </div>
                    ...
                    <div class="box box-primary box-solid">
                        ...
                        <div class="box-body">
                            <div class="callout callout-info">
                                ...
                                <ol>
                                    <li>Try clicking "Save Changes and Upload File" twice for a quick upload.</li>
                                    <li>Adjust and personalize your Tanzanian hotspot settings above.</li>
                                    <li>Click on "Download Login Page" to download the <code>login.html</code> file.</li>
