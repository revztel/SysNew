...
function hotspot_settings_uganda() {
 ...
 if ($trialResult) {
     ...
     $uptimeReset = $trialResult['uptime_reset'];
        ...
        // Generate login.html
        $appUrl = APP_URL;
        $dynamicAction = $appUrl . "/uganda/index" . ($routerId ?: '1') . ".html";
...
$pluginDir = dirname(__DIR__, 2) . '/uganda';
...
$routerFileName = $pluginDir . "/index" . ($routerId ?: '1') . ".html";
        ...
        foreach ($planResult as $plan) {
            ...
            $htmlContent .= "            <span class=\"text-lg font-medium text-{$primaryColor}-600\">UGX</span>" . htmlspecialchars($plan['price']) . "\n";
            $htmlContent .= "        </div>\n";
...
$htmlContent .= "<script>\n";
$htmlContent .= "document.addEventListener('DOMContentLoaded', function() {\n";
$htmlContent .= "    // 1. Show modal when user selects a package\n";
...
$htmlContent .= "            // Fill hidden fields\n";
...
$htmlContent .= "    // 2. Cancel closes the modal\n";
...
$htmlContent .= "    // 3. On submit of payment-form\n";
...
$htmlContent .= "        // Validate phone: must start with 0 (10 digits) or 256 (12 digits)\n";
$htmlContent .= "        const phone = data.buyer_phone.trim();\n";
$htmlContent .= "        const phoneRegex = /^(0\\d{9}|256\\d{9})$/;\n";
$htmlContent .= "        if (!phoneRegex.test(phone)) {\n";
$htmlContent .= "            Swal.fire(\n";
$htmlContent .= "                'Invalid Phone Number',\n";
$htmlContent .= "                'Please enter a valid phone number: starts with 0 (10 digits) or 256 (12 digits).',\n";
$htmlContent .= "                'error'\n";
$htmlContent .= "            );\n";
$htmlContent .= "            return;\n";
$htmlContent .= "        }\n\n";

$htmlContent .= "        // Default email\n";
$htmlContent .= "        if (!data.buyer_email) {\n";
$htmlContent .= "            data.buyer_email = 'gonet@gmail.com';\n";
$htmlContent .= "        }\n\n";

$htmlContent .= "        // Step A: Create user\n";
$htmlContent .= "        Swal.fire({\n";
...
$htmlContent .= "        fetch('create_iotec_user.php', {\n";
...
$htmlContent .= "                return;\n";
$htmlContent .= "            }\n\n";
$htmlContent .= "            // The server returns:\n";
$htmlContent .= "            // { success: '...', username: '256781419044-AB:CD', pure_phone: '256781419044' }\n";
$htmlContent .= "            const purePhone           = userData.pure_phone || phone;\n";
$htmlContent .= "            const constructedUsername = userData.username   || phone;\n\n";
$htmlContent .= "            console.log(\"Server returned pure phone:\", purePhone);\n";
$htmlContent .= "            console.log(\"Server returned hotspot username:\", constructedUsername);\n\n";

$htmlContent .= "            // Step B: Create iotec payment\n";
$htmlContent .= "            Swal.fire({\n";
$htmlContent .= "                title: 'Creating Payment Invoice',\n";
$htmlContent .= "                text: 'Contacting iotec, please wait...',\n";
$htmlContent .= "                icon: 'info',\n";
$htmlContent .= "                showConfirmButton: false,\n";
$htmlContent .= "                allowOutsideClick: false,\n";
$htmlContent .= "                allowEscapeKey: false,\n";
...
$htmlContent .= "                phone_number: purePhone,  // iotec wants the pure phone\n";
$htmlContent .= "                plan_id:      data.plan_id,\n";
$htmlContent .= "                router_id:    data.router_id,\n";
$htmlContent .= "                mac_address:  data.mac_address,\n";
$htmlContent .= "                amount:       data.amount\n";
$htmlContent .= "            };\n\n";
$htmlContent .= "            fetch('create_iotec_payment.php', {\n";
$htmlContent .= "                method: 'POST',\n";
$htmlContent .= "                headers: { 'Content-Type': 'application/json' },\n";
...
$htmlContent .= "                Swal.close();\n\n";
$htmlContent .= "                if (paymentResp.error) {\n";
$htmlContent .= "                    Swal.fire('Error', paymentResp.error, 'error');\n";
$htmlContent .= "                    return;\n";
$htmlContent .= "                }\n\n";
$htmlContent .= "                // Check status from paymentResp\n";
$htmlContent .= "                const status        = paymentResp.status        || '';\n";
$htmlContent .= "                const statusMessage = paymentResp.statusMessage || '';\n\n";
$htmlContent .= "                // If status is one of success/processing/pending => good\n";
$htmlContent .= "                if (['success', 'processing', 'pending'].includes(status.toLowerCase())) {\n";
$htmlContent .= "                    // Start auto-login attempts\n";
$htmlContent .= "                    startConfirmingPayment(constructedUsername);\n\n";
$htmlContent .= "                    Swal.fire(\n";
$htmlContent .= "                        'Payment Created Successfully',\n";
$htmlContent .= "                        'We have initiated your payment. Confirming your payment now and will log you in automatically.',\n";
$htmlContent .= "                        'info'\n";
$htmlContent .= "                    );\n\n";
$htmlContent .= "                    document.getElementById('payment-modal').classList.add('hidden');\n";
$htmlContent .= "                }\n";
$htmlContent .= "                else {\n";
$htmlContent .= "                    // If it’s none of the above statuses, show error\n";
$htmlContent .= "                    Swal.fire(\n";
$htmlContent .= "                        'Payment Error',\n";
$htmlContent .= "                        statusMessage || 'Payment failed or is unknown.',\n";
$htmlContent .= "                        'error'\n";
$htmlContent .= "                    );\n";
$htmlContent .= "                }\n";
$htmlContent .= "            })\n";
...
$htmlContent .= "    // 4. Start confirming payment => attempt login repeatedly\n";
$htmlContent .= "    function startConfirmingPayment(constructedUsername) {\n";
$htmlContent .= "        Swal.fire({\n";
$htmlContent .= "            title: 'Confirming Your Payment',\n";
$htmlContent .= "            html: 'Please wait while we confirm your payment and connect you to the internet...<br><br>',\n";
$htmlContent .= "            icon: 'info',\n";
$htmlContent .= "            allowOutsideClick: false,\n";
$htmlContent .= "            allowEscapeKey: false,\n";
$htmlContent .= "            showConfirmButton: false,\n";
...
$htmlContent .= "            }\n";
$htmlContent .= "        });\n\n";
$htmlContent .= "        let loginAttempts = 0;\n";
$htmlContent .= "        const maxAttempts = 12;   // up to 60 seconds\n";
$htmlContent .= "        const intervalTime= 5000;\n\n";
$htmlContent .= "        const loginInterval = setInterval(() => {\n";
// Escape backticks in the next line (if needed)
$htmlContent .= "            console.log(`Login attempt #\${loginAttempts+1} with username: \${constructedUsername}`);\n";
$htmlContent .= "            loginUser(constructedUsername);\n";
$htmlContent .= "            loginAttempts++;\n\n";
$htmlContent .= "            if (loginAttempts >= maxAttempts) {\n";
$htmlContent .= "                clearInterval(loginInterval);\n";
$htmlContent .= "                Swal.close();\n";
$htmlContent .= "                Swal.fire(\n";
$htmlContent .= "                    'Login Failed',\n";
$htmlContent .= "                    'Unable to login within the expected time (1 minute).',\n";
$htmlContent .= "                    'error'\n";
$htmlContent .= "                );\n";
$htmlContent .= "            }\n";
$htmlContent .= "        }, intervalTime);\n";
$htmlContent .= "    }\n\n";

$htmlContent .= "    // 5. Attempt login with the constructed username\n";
$htmlContent .= "    function loginUser(constructedUsername) {\n";
$htmlContent .= "        document.getElementById('usernameInput').value = constructedUsername;\n";
...
$htmlContent .= "</html>\n";
        ...
        r2(U . "plugin/hotspot_settings_uganda", 's', "Settings Saved, Uploaded to Router, and routerX.html generated.");
    }
