    ...
    public function __construct(
        ...
        try {
            ...
            throw new SocketException(
                'FreeIspRadius is experiencing difficulty connecting to your router, which may be offline. To verify its status, please navigate back to Network > Routers and check the routers current status',
